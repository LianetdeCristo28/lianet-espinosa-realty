      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <Button
            ...
            className="w-full sm:w-auto bg-[#D2B463] text-[#17140F] hover:bg-[#D2B463]/90 text-xl px-12 py-8 rounded-full shadow-lg hover:scale-105 transition-all disabled:opacity-50"
          >
