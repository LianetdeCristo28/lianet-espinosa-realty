...
import { LOFTY_LISTING_BASE as LOFTY_BASE_URL } from "@shared/constants";
...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden pt-16 pb-20 md:pb-0">
        ...
        <section id="hero" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          <svg aria-hidden="true" focusable="false" className="absolute inset-0 z-[5] w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg">
            <defs>
        ...
        {/* 2. SOBRE MÍ */}
        <section id="sobre-mi" className="py-16 sm:py-24 bg-[#F8F6F2] overflow-x-hidden">
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative flex flex-col items-center py-16 w-full max-w-full">
                ...
                <div className="absolute left-0 top-20 bg-white rounded-2xl shadow-lg px-2 py-2 sm:px-4 sm:py-3 flex items-center gap-2 sm:gap-3 z-20 border border-[#E2D9CC]">
                  <div className="w-7 h-7 sm:w-9 sm:h-9 bg-[#F7F3EC] rounded-full flex items-center justify-center flex-shrink-0">
                    <svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#C9A455" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <a
        ...
        className="fixed bottom-36 md:bottom-8 right-4 md:right-8 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full shadow-md flex items-center justify-center hover:scale-105 transition-all duration-300 hover:bg-[#22c55e]"
      >
        <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" className="w-7 h-7 fill-current" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.div
        ...
        animate={{ y: 0 }}
        transition={{ delay: 2 }}
        className="fixed bottom-0 left-0 right-0 z-40 md:hidden pointer-events-none px-4 pb-4 pt-2"
      >
        <Button
          data-testid="button-mobile-cta"
          onClick={() => setDiagnosticOpen(true)}
          className="w-full bg-[#17140F] text-white shadow-xl py-5 rounded-full font-bold pointer-events-auto text-base"
        >
          ¿En qué paso estoy?
        </Button>
      </motion.div>
