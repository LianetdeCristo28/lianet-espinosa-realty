...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      {/* ============================================ */}
      {/* COMPRADORES - Contenedor principal           */}
      {/* ============================================ */}
      <div id="compradores">
        {/* Section Header */}
        <section className="pt-24 pb-8 bg-[#F8F6F2]">
        ...
        {/* Sub-section: Pain Points */}
        <section className="py-20 bg-[#E5E1D8]">
          <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        {/* Sub-section: Support / Acompañamiento */}
